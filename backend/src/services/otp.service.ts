...
export async function sendOtp(identifier: string): Promise<{ masked: string; ttlSeconds: number; code: string }> {
...
export function getStoredOtp(identifier: string): { code: string; expiresAt: number } | undefined {
