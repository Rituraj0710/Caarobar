...
const months = [
  { label: '01-January', pen: 0, rej: 0, app: 2, percent: '98%' },
  { label: '02-February', pen: 0, rej: 2, app: 2, percent: '98%' },
  { label: '03-March', pen: 1, rej: 1, app: 2, percent: '98%' },
  { label: '04-April', pen: 0, rej: 1, app: 2, percent: '98%' },
  { label: '05-May', pen: 1, rej: 1, app: 2, percent: '100%' },
  { label: '06-June', pen: 0, rej: 1, app: 2, percent: '98%' },
  { label: '07-July', pen: 0, rej: 1, app: 2, percent: '98%' },
  { label: '08-August', pen: 0, rej: 2, app: 2, percent: '98%' },
  { label: '09-September', pen: 1, rej: 0, app: 2, percent: '100%' },
  { label: '10-October', pen: 0, rej: 1, app: 2, percent: '98%' },
  { label: '11-November', pen: 1, rej: 1, app: 0, percent: '100%' },
  { label: '12-December', pen: 0, rej: 0, app: 0, percent: '—' },
];
    ...
    <View style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
        ...
        <View style={{ marginHorizontal: 12, backgroundColor: '#FFFFFF', borderRadius: 12, borderColor: '#E6E6E6', borderWidth: 1, padding: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 }}>
          ...
          <Text style={{ textAlign: 'center', color: '#E53935', fontSize: 12, fontWeight: '700', marginBottom: 6 }}>LEAVE REQUEST REPORT</Text>
        ...
        <View style={{ marginHorizontal: 12, marginTop: 10, borderWidth: 1, borderColor: '#E6E6E6', borderRadius: 8, overflow: 'hidden' }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#F6F7FB', paddingHorizontal: 10, height: 40 }}>
            ...
            <Text style={{ width: 60, textAlign: 'center', fontSize: 12, color: '#111' }}>Percent</Text>
          </View>

          {/* Rows */}
          {months.map((m, idx) => (
            <View key={m.label} style={{ flexDirection: 'row', alignItems: 'center', height: 40, borderTopWidth: 1, borderTopColor: '#E6E6E6', backgroundColor: '#FFFFFF' }}>
              <View style={{ flex: 1, paddingHorizontal: 12, justifyContent: 'center' }}>
                <Text style={{ fontSize: 12, color: '#111' }}>{m.label}</Text>
              </View>
              <Text style={{ width: 48, textAlign: 'center', color: '#F59E0B', fontSize: 12 }}>{m.pen || 0}</Text>
              <Text style={{ width: 48, textAlign: 'center', color: '#EF4444', fontSize: 12 }}>{m.rej || 0}</Text>
              <Text style={{ width: 48, textAlign: 'center', color: '#22C55E', fontSize: 12 }}>{m.app || 0}</Text>
              <Text style={{ width: 60, textAlign: 'center', color: '#111', fontSize: 12 }}>{m.percent}</Text>
            </View>
          ))}
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', height: 40, borderTopWidth: 1, borderTopColor: '#E6E6E6', backgroundColor: '#FFF5F5' }}>
            ...
            <Text style={{ width: 48, textAlign: 'center', color: '#111', fontSize: 12 }}>6</Text>
            <Text style={{ width: 48, textAlign: 'center', color: '#111', fontSize: 12 }}>8</Text>
            <Text style={{ width: 48, textAlign: 'center', color: '#111', fontSize: 12 }}>14</Text>
            <Text style={{ width: 60, textAlign: 'center', color: '#111', fontSize: 12 }}>98.5%</Text>
          </View>
        </View>
      </ScrollView>
    </View>
