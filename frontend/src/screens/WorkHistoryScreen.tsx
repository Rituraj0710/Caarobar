        ...
        <View style={{ marginBottom: spacing(16) }}>
          <View style={{ borderWidth: 1, borderColor: '#CCCCCC', backgroundColor: '#FFFFFF' }}>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: '#F5F5F5', borderBottomWidth: wp(1), borderBottomColor: '#CCCCCC' }}>
              ...
              <View style={{ flex: 1.2, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing(8), borderRightWidth: wp(1), borderRightColor: '#CCCCCC' }}>
                <Image 
              ...
              <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing(8), borderRightWidth: wp(1), borderRightColor: '#CCCCCC' }}>
                <Text style={{ fontSize: fontSize(11), color: '#000000', fontFamily: 'Poppins-SemiBold', fontWeight: '600' }} allowFontScaling={false}>T.Hr</Text>
              </View>
              <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing(8), borderRightWidth: wp(1), borderRightColor: '#CCCCCC' }}>
                <Text style={{ fontSize: fontSize(11), color: '#000000', fontFamily: 'Poppins-SemiBold', fontWeight: '600' }} allowFontScaling={false}>O.T</Text>
              </View>
              <View style={{ flex: 1.5, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing(8) }}>
            ...
            {workHistoryData.map((monthData, index) => (
              ...
              >
                <View style={{ flex: 2, paddingVertical: spacing(8), paddingHorizontal: spacing(8), borderRightWidth: wp(1), borderRightColor: '#CCCCCC', borderBottomWidth: wp(1), borderBottomColor: '#CCCCCC' }}>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: '#FFE5E5' }}>
              ...
              <View style={{ flex: 1.2, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing(8), borderRightWidth: wp(1), borderRightColor: '#CCCCCC' }}>
                <Text style={{ fontSize: fontSize(12), fontWeight: '700', color: '#E53935', fontFamily: 'Poppins-Bold' }} allowFontScaling={false}>
                  {grandTotal.absent}
                </Text>
              </View>
              <View style={{ flex: 1.2, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing(8), borderRightWidth: wp(1), borderRightColor: '#CCCCCC' }}>
                <Text style={{ fontSize: fontSize(12), fontWeight: '700', color: '#4CAF50', fontFamily: 'Poppins-Bold' }} allowFontScaling={false}>
                  {grandTotal.present}
                </Text>
              </View>
              <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing(8), borderRightWidth: wp(1), borderRightColor: '#CCCCCC' }}>
                <Text style={{ fontSize: fontSize(12), fontWeight: '700', color: '#000000', fontFamily: 'Poppins-Bold' }} allowFontScaling={false}>
