...
type Props = NativeStackScreenProps<RootStackParamList, 'PaymentRequestReport'>;
...
export default function PaymentRequestReportScreen({ navigation }: Props) {
  const insets = useSafeArea();
  const [selectedYear] = useState('2025');

  // Calculate grand totals
  const grandTotal = paymentData.reduce((acc, month) => ({
              ...
              >
                <View style={{ 
                  ...
                  <View style={{ 
                    ...
                    borderBottomWidth: index === paymentData.length - 1 ? 0 : wp(1), 
