...
export default function AdminHomeScreen({ navigation }: Props) {
  ...
  const quickActions = [
    ...
    { name: 'Admin', icon: require('../../assets/admin.png'), bgColor: '#FFFFFF', hasNotification: false, onPress: () => navigation.navigate('EmployeeManagement') },
  ];
      ...
      <View style={{ 
        ...
        <View style={{ flexDirection: 'row', alignItems: 'flex-start', flex: 1, minWidth: 0 }}>
          ...
          >
            <Image 
              ...
              style={{ width: wp(32), height: hp(32), borderRadius: hp(16), resizeMode: 'cover' }} 
            />
          </TouchableOpacity>
        ...
        <View style={{ 
          ...
          <TouchableOpacity style={{ padding: spacing(4), marginLeft: spacing(8) }}>
            <Image source={require('../../assets/share_in header.png')} style={{ width: wp(22), height: hp(22), resizeMode: 'contain' }} />
          </TouchableOpacity>
        </View>
      </View>

      {/* Fixed User Profile and Time Tracking Card */}
      <View style={{ marginHorizontal: spacing(16), marginTop: spacing(12), backgroundColor: '#FFFFFF', borderRadius: hp(20), padding: spacing(18), shadowColor: '#000', shadowOffset: { width: 0, height: hp(2) }, shadowOpacity: 0.08, shadowRadius: spacing(8), elevation: 3, borderWidth: wp(1), borderColor: '#E6E6E6' }}>
        ...
        <View style={{ 
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', flexShrink: 0 }}>
            ...
            <Text style={{ fontSize: fontSize(14), color: '#555', fontFamily: 'Poppins-Medium' }} allowFontScaling={false}>Date</Text>
          </View>
          {/* Right date value */}
        ...
        <View style={{ marginBottom: spacing(16), alignItems: 'center' }}>
          <Text style={{ fontSize: fontSize(13), color: '#888', fontFamily: 'Poppins' }} allowFontScaling={false}>
            Branch - <Text style={{ color: '#FF5252', fontWeight: '600' }} allowFontScaling={false}>Vinod handlooms</Text>
          </Text>
        </View>

        {/* Working Hours */}
        <View style={{ marginBottom: spacing(16), alignItems: 'center' }}>
          <Text style={{ fontSize: fontSize(13), color: '#888', fontFamily: 'Poppins', marginBottom: spacing(8) }} allowFontScaling={false}>Total Working Hours</Text>
          <Text style={{ fontSize: fontSize(32), fontWeight: '700', color: '#248CFF', fontFamily: 'Poppins-Bold', letterSpacing: spacing(2) }} allowFontScaling={false}>00 : 00 : 00</Text>
        </View>

        <View style={{ height: hp(1), backgroundColor: '#E6E6E6', marginVertical: spacing(8), marginHorizontal: -spacing(6) }} />
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, minWidth: 0 }}>
              ...
              <View style={{ 
                ...
                <View style={{ 
                  ...
                  <View style={{ position: 'absolute', top: hp(2), left: wp(5), width: wp(1), height: hp(3), backgroundColor: '#888888' }} />
                  <View style={{ position: 'absolute', top: hp(4), left: wp(5), width: wp(3), height: hp(1), backgroundColor: '#888888' }} />
                </View>
              </View>
              <Text 
                style={{ 
        ...
        <View style={{ flexDirection: 'row', gap: spacing(14) }}>
          <TouchableOpacity style={{ flex: 1, backgroundColor: '#4CAF50', height: hp(52), borderRadius: hp(28), alignItems: 'center', justifyContent: 'center', shadowColor: '#4CAF50', shadowOffset: { width: 0, height: hp(4) }, shadowOpacity: 0.3, shadowRadius: spacing(8), elevation: 4 }}>
            <Text style={{ color: '#fff', fontSize: fontSize(16), fontFamily: 'Poppins-Bold' }} allowFontScaling={false}>Punch In</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ flex: 1, backgroundColor: '#FF3B3B', height: hp(52), borderRadius: hp(28), alignItems: 'center', justifyContent: 'center', shadowColor: '#FF3B3B', shadowOffset: { width: 0, height: hp(4) }, shadowOpacity: 0.3, shadowRadius: spacing(8), elevation: 4 }}>
            <Text style={{ color: '#fff', fontSize: fontSize(16), fontFamily: 'Poppins-Bold' }} allowFontScaling={false}>Punch Out</Text>
          </TouchableOpacity>
        </View>
      </View>
